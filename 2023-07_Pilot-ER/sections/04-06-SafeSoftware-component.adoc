...
Figure 1. Environment Canada NetCDF GCM  time series downscaled to Vancouver area
From: https://climate-change.canada.ca/climate-data/#/downscaled-data 


Figure 2. Data Cube to ARD: NetCDF to KML, Geopackage, GeoTIFF
...
Figure 3. Extracted timestep  grids: Monthly timesteps, period mean T, period max T


Figure 4. Convert raster temperature grids into temperature contour areas by class
