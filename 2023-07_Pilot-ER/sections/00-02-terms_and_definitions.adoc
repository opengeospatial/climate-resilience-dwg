...
FAIR principles footnote:[further reading: https://www.go-fair.org/fair-principles/]:: The approach of making digital assets Findable, Accessible, Interoperable, and Reusable.
