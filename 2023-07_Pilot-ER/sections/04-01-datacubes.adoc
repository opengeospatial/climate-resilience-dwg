...
The https://docs.ogc.org/DRAFTS/19-087.html[_OGC API - Coverage_] candidate Standard is a simple API defining fundamental functionality to retrieve access data for arbitrary fields,
