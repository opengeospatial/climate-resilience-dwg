...
[options="header"]
|===
|Dataset or Database name |Variables |Data provider |Year of release |Data source |Accessibility |Data format |Temporal resolution |Temporal coverage |Spatial resolution |Spatial coverage
...
|1983-01-01 - present (1983-2020 CDR + ICDR up to present - 5 days)
| 0.05° x 0.05° degrees
| ±65° longitude and ±65° latitude
...
|CMASAF: 2007-2016, SARAH: 2005-2016, SARAH2: 2005-2020, NSRDB: 2005-2015
|CMSAF: 0.025°, SARAH2: (0.05°) for SARAH-2 and 0.25° for ERA5, NSRDB: 0.04°
|CMASAF: 65N-35S, 65W-65 E, SARAH: 62.5N-40S, 65W-128E, SARAH2: 72N-37S, 20W-63,5E, NSRDB: 60N-20S, 180W-22.5W
...
|1994-2018 (free data)
|9 arcsec (~250m:  GHI, DIF, GTI, DNI),  30 arcsec (~1km: PVOUT) and 2 arcmin (~4km: OPTA)
|Global
...
|2004 to present
|Interpolated to the point of interest from various input data spatial resolutions (0.2°)
|Worldwide
...
|hourly time series
|1986-2015
|country, bidding zone (special aggregations to reflect the power market reality), NUTS-1 and NUTS-2 level 
|European Union 
...
|TXT, CSV
|hour, day, month, year
|1996–2015, hourly data: 2010 - present
|Time series for a given point worldwide
|Global
|===
...
[options="header"]
|===
|Service name |Variables & Info |Data provider |Year of first release |Data source |Accessibility |Functionality |Temporal resolution |Temporal coverage |Spatial resolution |Spatial coverage
...
|Month, Season, Year
|1991-2014
|Original maps based on 0.05° degrees data
|Poland
...
|1991-2014
|Original maps based on 0.05° degrees data
|18 - 29 E, 53.5 - 60 N (whole coverage for Lithuania, Latvia, Estonia, for Poland only the North-East part)
...
|Day of year
|Only multiannual values (1983-2020)
|Point data
|Global
...
|Database dependent 2005 - 2015/2020
|Database dependent
|Global (almost complete coverage)
...
|Depending on the region: 1994/1999/2007/2018 to 2021
|250 m to 1km dependent on variable
|Global (almost)
...
|Database dependent, between 1994 and 2020
|Database dependent, between 1km and 20 km
|Global
...
|1994-2020
|250m - 1km
|Global (a few countries still missing)
...
|1 min, 15 min, 1 h, 1 day, 1 month
|2004 to present
|Interpolated to the point of interest from various input data spatial resolutions
|Global for cloud-free parameters, Meteosat satellite field-of-view for all-sky parameters
...
|Various
|Various
|Global, but best data are available for developing countries (Afghanistan, Bangladesh, Columbia, Ghana, India, Kenya, Mexico, Nepal, Pakistan, Peru, Kazakhstan and Central Asia)
...
|MERRA-2: 1980-2019, SARAH: 1985-2016
|Country-level or Point of interest
|Europe (globally with data from MERRA reanalyses)
...
|Various
|Various
|Global data, but MSG data for Meteosat Disc
|===
