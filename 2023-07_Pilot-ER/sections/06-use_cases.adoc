...
Different solar radiation climate data records and their characteristics have been listed in the table below. All the datasets cover the area of Poland but are not ready for direct use at national level. 
...
Identified datasets and services provide generalised information on spatio-temporal solar radiation patterns (high resolution grids for longer period not available at all or not for free!). A set of high-resolution data products dedicated to specific applications and in user-friendly formats at the national level to support decision-making processes is needed.
