...
The identified solar radiation services are currently being analized in terms of overall functional scope, usability of the interface, innovative tools and possible shortcomings. 
