...
- The sources used to calculate the combined indicator currently includes only historical data. If Soil Moisture or FAPAR projections can be obtained, these could be combined with future predictions of precipitation from SafeSoftware and NOAA to project the CDI into the future.
