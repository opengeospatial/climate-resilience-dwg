...
[[Pixalytics_forecast]]
.Plot of the ECMWF precipitation and SPI, extended using the climate forecast data compared to the GDO calculated SPI; generated using Copernicus Emergency Management Service information, Copernicus Climate Service and  Canadian Centre for Climate Services data [2023]
image::Pixalytics-forecast-example.png[Pixalytics-forecast]
...
//=== Safe Software
=== From raw data to ARD with the FME engine 
