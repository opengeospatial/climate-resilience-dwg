...
Figure 2 - Sentinel-2 RBG composite (red Band4, green Band3, blue Band2), over Hubei, acquired on October 22, 2020. (a) corresponds to the reflectance at the top of the atmosphere (L1C product); (b) corresponds to the surface reflectance after pre-processing.
...
Figure 3 - Flow of the SPEI calculation
...
Figure 4 - The SPEI results for the date 2000_02_01
...
Figure 5 - The UML model of WHU Data Cube.
...
Figure 6 - The coverage with the ID "2m_temperature_201602" in the Asian region.
