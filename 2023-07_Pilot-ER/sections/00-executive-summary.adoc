...
The pilot points out the challenges on how to provide information to the decission makers. Therefore, a dedicated chapter and focus  on comunication is included in the pilots work. This chapter highlights special approaches showing the comunication options to non technical people who often are in charge of local climate ressilince action strategies. 
