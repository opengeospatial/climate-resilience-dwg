...
Wuhan University (WHU) is a university that plays a significant role in researching and teaching all aspects of surveying and mapping, remote sensing, photogrammetry, and geospatial information sciences in China. Our group has been working on geospatial interoperability, data processing, provenance, and machine learning for many years and has wide influence among the Chinese GIS community. The group members have rich experiences in developing standards and technologies for geospatial interoperability, such as the participation in OGC innovation programs including OWS-9, OWS-10, Testbed 12, Testbed13, Testbed 17, Disaster Resilience Pilot 2019 (DRP-2019), Disaster Pilot 2021 (DP-2021), Environmental Data Retrieval (EDR) API SWG, and Training Data Markup Language for Artificial Intelligence (TrainingDML-AI) SWG. In this Climate Resilience Pilot, WHU will contribute three components (Surface Reflectance ARD, Drought Indicator, and Data Cube Infrastructure) and one use-case (Drought Impact Use cases). 
